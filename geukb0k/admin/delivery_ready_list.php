...
if($mode=="list_update"){
	...
	alert("일괄 배송완료 처리되었습니다","delivery_ready_list.php?$qstr");
	exit;
}
...
<tr>
	...
	<a href="delivery_ready_list.php?mode=excel&<?=$qstr?>"><img src="img/ex_down.gif" alt="엑셀다운" align="absmiddle"></a>
	</form>
	</td>
</tr>
</table>
...
<form name="flist" id="flist" method="post" action="delivery_ready_list.php">
