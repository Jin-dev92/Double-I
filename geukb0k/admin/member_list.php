...
if($mode=="update"){
	...
	sql_query($sql);
	alert("선택한 인원에 대해서 탈퇴신청 처리되었습니다","member_list.php?$qstr");
	exit;
}
...
$sql_search = " where is_supply='0' and mb_leavedatetime='' ";
...
<tr>
	...
	<a href="member_list.php?mode=excel&<?=$qstr?>"><img src="img/ex_down.gif" alt="엑셀다운" align="absmiddle"></a>
	</form>
	</td>
</tr>
</table>	

<form name="flist" id="flist" method="post" action="member_list.php">
...
<tr onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''" bgcolor="#FFFFFF">
	...
	<td><a href="member_form.php?mb_no=<?=$row[mb_no]?>&<?=$qstr?>"><img src="img/su_btn.gif"></a></td>
	<td><a href="javascript:del('member_list.php?mode=update&mb_no=<?=$row[mb_no]?>&<?=$qstr?>')"><img src="img/del_btn.gif"></a></td>
</tr>
<?
}
...
<div class="btn_cen"><a href="javascript:nfor_list('탈퇴신청','list_update')"><img src="img/sun_del.gif" alt="선택삭제"></a><a href="member_form.php?<?=$qstr?>"><img src="img/dong_btn.gif"></a></div>
</form>
<?
include "tail.php";
?>