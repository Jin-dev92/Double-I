...
if($mode=="list_update"){
	...
	for($i=0; $i<count($chk); $i++){
		$k = $_POST['chk'][$i];
		sql_query("update nfor_cart set ticket_send='2', ticket_number='{$_POST['ticket_number2'][$k]}' where ct_id='{$_POST['ct_id'][$k]}'");
...
$sql_search = " where cart_id=cart_id and pay_step='1' and delivery_step='0' and ticket_send>'0' and it_delivery='0' ";
...
<div class="btn_cen"><a href="javascript:nfor_list('티켓재발급','list_update')"><img src="img/delivery1_btn.gif" alt="티켓재발급처리"></a></div>
</form>
