...
$max = 0;
$sum_count = 0;
$result = sql_query(" select wr_date, wr_count as cnt from nfor_count_sum where wr_date between '$sdate' and '$edate' order by wr_date desc ");
for($i=0; $row=sql_fetch_array($result); $i++) {
    $arr[$row[wr_date]] = $row[cnt];
