  ...
  <?
      if($_POST['action']=='go'){
       ...
       /******************** 인증정보 ********************/
        ...
        $sms['user_id'] = base64_encode("geukboksms"); //SMS 아이디.
        $sms['secure'] = base64_encode("d8eded2f741c89b50e15a20f89ddc459") ;//인증키
        ...
        // echo "<script>location.href = 'http://www.geukbok.com/admin/order_wait_list.php'</script>";
