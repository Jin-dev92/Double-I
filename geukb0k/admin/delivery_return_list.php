...
$sql_search = " where delivery_step='4' and it_delivery='1' ";	// and pay_step='1'
...
<tr>
	...
	<a href="delivery_return_list.php?mode=excel&<?=$qstr?>"><img src="img/ex_down.gif" alt="엑셀다운" align="absmiddle"></a>
	</form>
	</td>
</tr>
</table>
...
<form name="flist" id="flist" method="post" action="delivery_return_list.php">
