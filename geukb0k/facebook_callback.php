...
$tokenMetadata->validateAppId($api[facebook_appid]); // Replace {app-id} with your app id
...
$mb = sql_fetch("select * from nfor_member where mb_facebook_id='$facebook_id'");
...
$_SESSION[facebook_name] = $mb_name;
$_SESSION[facebook_email] = $mb_email;
