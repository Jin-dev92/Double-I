...
<li class="a_li">
	...
	<div>
		<span class="qna_list_name"><i></i><b></b><?=print_mb_info($data2)?></span>
	...
	<div class="qna_memo" id="qna_memo_<?=$data2[wr_id]?>"><?=item_qna_memo($data2)?></div>
	<? if(($member[mb_no] and $data2[mb_no]==$member[mb_no]) or $is_admin){ ?>
	<div class="qna_list_btn">
		<button type="button" class="update" data-mode="update" data-wr_id="<?=$data2[wr_id]?>">수정</button>
