...
<div class="mb_join_wrap">
	...
	<p>기본정보</p>
	<div class="mb_join_row"><input type="text" name="mb_name" id="mb_name" placeholder="이름" value="<?=$_SESSION[mb_name]?>"></div>
	...
	<div class="mb_join_row"><input type="number" pattern="[0-9]*" name="mb_hp" id="mb_hp" placeholder="휴대폰번호(-없이 입력)"></div>
	...
	<? if($nfor[id_type]=="mb_id"){ ?>
	<div class="mb_join_row"><input type="text" name="mb_id" id="mb_id" placeholder="아이디"></div>
	<p id="mb_id_msg" class="p_msg"></p>
	<? } ?>

	<div class="mb_join_row"><input type="email" name="mb_email" id="mb_email" placeholder="이메일" value="<?=$_SESSION[mb_email]?>"></div>
	<p id="mb_email_msg" class="p_msg"></p>

	<div class="mb_join_row"><input type="password" name="mb_password" id="mb_password" placeholder="비밀번호"></div>
	<p id="mb_password_msg" class="mb_row_p">영문/숫자 또는 특수문자 조합 6~16자리로 입력해 주세요.</p>

	<div class="mb_join_row"><input type="password" name="mb_password_confirm" id="mb_password_confirm" placeholder="비밀번호확인"></div>
