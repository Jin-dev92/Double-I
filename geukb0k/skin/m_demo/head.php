...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-119601759-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-119601759-1');
</script>
...
<div id="wrap">
	...
	<header id="header">
		...
		<nav id="gnb">
			<a href="javascript:history.back();" class="btn_back"><i></i>뒤로</a>
			<span class="txt_title"><?=$nfor[title]?></span>


			<? if(basename($PHP_SELF)=="item.php"){ ?>
			<a href="cart.php" class="btn_cart"><i></i>장바구니<span id="cart_cnt"><?=cart_cnt($_SESSION[cart_id])?></span></a>
			<? } else{ ?>
