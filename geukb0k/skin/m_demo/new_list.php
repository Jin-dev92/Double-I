...
<div class="it_newpro_tit"><img src="/skin/m_demo/img/newpro.png"><span><b><?=date("m")?>월 <?=date("d")?>일</b> 신규상품 안내</span></div>

<style>
.it_newpro_tit{height:50px;text-align:center;padding:10px 0px 0px 0px; }
.it_newpro_tit span{line-height:45px;font-size:18px;height:45px;vertical-align:baseline;color:#343434;}
...
<li>
	...
	<a href="<?=$item[url]?>">
		...
		<div class="img_wrap">
			...
			<!--<img data-original="<?=$item[it_img_m1]?"$nfor[path]/data/main/$item[it_img_m1]":"$nfor[path]/img/item_list_noimg.jpg"?>" alt="" class="img1 lazy">
