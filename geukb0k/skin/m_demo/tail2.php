	...
	#footer i{ display:block; background:url(<?=$nfor[skin_path]?>img/layout.png) no-repeat 0 0; background-size:320px auto; width:25px; height:25px; margin:0 auto; margin-top: -30px;}
