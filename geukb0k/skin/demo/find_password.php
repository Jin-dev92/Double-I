...
<style>
.findpw {width: 362px; margin: 0 auto; padding: 28px 20px;}
.findpw h2{ width:349px; padding-bottom:5px; margin-bottom:25px; border-bottom: 1px solid #d6d6d6; font-size:1.3em; font-weight:bold; display:block; }
.findpw h3{ margin-bottom:10px; font-size: 1.1em; font-weight:bold; }
.back{width:325px; height:75px;padding: 16px 0 0 24px; background: #f5f5f5;}
.btn{ line-height:45px ;text-align:center; display:block; width: 150px; height:45px; font-size:1.1em; color:#fff; font-weight:bold; cursor:pointer; border-radius:3px;  -webkit-border-radius: 3px; background:#a676f4; border:0px; margin: 20px auto;}
...
<div class="findpw">
	...
	<a href="#" id="email_check_btn" class="btn">이메일로 찾기</a>
	...
	<a href="#"  id="hp_check_btn" class="btn">핸드폰번호로 찾기</a>


	<div class="back2">
	<p>☎ 고객센터 : <?=$config[cf_tel]?></p> 
	<a href="find_id.php" class="btn2" style="cursor: pointer;">아이디 찾기</a>
	</div>
