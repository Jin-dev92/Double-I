...
class NicepayLite
{
	...
	function startAction() {
		...
		// 신용카드 빌링	
			...
			$this->m_queryString["BrandName"]	= $this->m_BrandName;
			...
			if($this->m_charSet =="UTF8"){
				...
				$this->m_queryString["BrandName"] = iconv("UTF-8", "EUC-KR",$this->m_queryString["BrandName"]);
			}
	...
	function ParseMsg($result_string,$NICELog) {
	 ...
	 //    $this->m_ResultData[BrandName1] = iconv("EUC-KR", "UTF-8",$this->$m_BrandName);
		// $this->m_ResultData[BrandName2] = iconv("UTF-8","EUC-KR", $this->$m_BrandName);
		// $this->m_ResultData[BrandName3] = $this->$m_BrandName;
	}
