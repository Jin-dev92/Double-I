...
<style>
.order_banking { border-top:solid 2px #666;border-bottom:solid 1px #d8d5d5; border-left:solid 1px #d8d5d5; border-right:solid 1px #d8d5d5;  margin-bottom:10px; background:#fff; padding:20px; }


.order_banking_msg {  padding:0px; font-size:14px; color:#444; line-height:35px ; }
.order_banking_msg  p { border-bottom:solid 1px #DCDCDC; }

.order_banking_msg .notice { color:#cc0000; }
...
#order_list_wrap { padding:0px; background-color:#fff; }
...
<style>
.price_wrap {  border-top:solid 2px #666;border-bottom:solid 1px #d8d5d5; border-left:solid 1px #d8d5d5; border-right:solid 1px #d8d5d5; padding:10px; margin:10px 0px; }
.price_wrap table { margin:5px 0px 5px 0px; width:100%; line-height:30px; }
...
.price_wrap b{ font-size:24px;color:#f6706f;}



.table-cell a { margin:0 auto; }
...
<div class="price_wrap">
	...
	<tr>
		...
		<td class="border_top"><b><?=$order[payment_type]=="money"?"0":number_format($order[$order[payment_type]."_price"])?></b> 원</td>
	</tr>
	<? if($order[cancel_price]){ ?>
	<tr>
		<th>취소금액</th>
		<td><b><?=number_format($order[cancel_price])?></b> 원</td>
	</tr>
	<? } ?>
	</tbody>
	</table>
...
<? } ?>
		...
		<div class="table-row">
			...
			?>
			<div class="table-cell"><a id="order_hide_btn" class="table-btn" style="width:150px;">주문내역 숨김</a></div>
			<? } ?>
		</div>
		</div>
