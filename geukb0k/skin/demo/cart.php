...
<style>
.cart_wrap{ width:1124px;; margin:20px; }
.cart_wrap .cartimg{width:1124px; height:100px; background-color:#d32f2f; margin-bottom:20px;}
...
.option_delete { position:absolute; top:0px; right:0px; cursor:pointer; padding:0px; width:31px; height:31px; background: url("/skin/m_demo/img/layout.png") no-repeat; background-size: 320px auto; background-position: -100px -450px; }
...
.ea_sum_box span { font-size:14px; line-height:55px; }
...
.cart_order_btn { float:left;display:block; width:250px; height:40px; line-height:40px; text-align:center; padding:0px; margin:0px; margin:20px 5px; font-size:16px; font-weight:bold; background-color:#d32f2f; border:solid 1px #d32f2f; color:#fff; }
.cart_order_btn:hover { background-color:#FFFFFF; border:solid 1px #d32f2f; color:#d32f2f; }
.cart_order_btn2 { float:left; display:block; width:250px; height:40px; line-height:40px; text-align:center; padding:0px; margin:0px; margin:20px 0px; font-size:16px; font-weight:bold; border:solid 1px #DCDCDC; color:#666; }


.option_plus { cursor:pointer; display:block; padding:0px; border:solid 1px #c9c9c9; width:33px; height:29px; position:absolute; right:0px; top:0px; background:url(/skin/m_demo/img/layout.png) no-repeat;background-size: 320px auto; background-position: -0px -450px; }
.option_minus {cursor:pointer; display:block; padding:0px; border:solid 1px #c9c9c9; width:33px; height:29px; position:absolute; left:0px; top:0px; background:url(/skin/m_demo/img/layout.png) no-repeat;background-size: 320px auto;background-position: -50px -450px;}
...
<div class="container_cus">
	<div class="cart_wrap">
	<div class="cartimg"><img src="/skin/demo/img/cartimg.png"></div>
	
<!-- 
		<b class="my_title"><?=$nfor[title]?></b> -->
	...
	<li class="cart_item_wrap" id="it_id_<?=$item[it_id]?>">
		...
		<li id="option_id_<?=$ct[option_id]?>">
			...
			<div class="option_count_price_wrap">
				<p class="option_count"><input type="number" pattern="[0-9]*" name="option_cnt[]" class="option_cnt" value="<?=$ct[option_cnt]?>" data-option_id="<?=$ct[option_id]?>" data-option_price="<?=$ct[option_price]?>" style="height:25px; width:113px; text-align:center;"><a class="option_plus" data-option_id="<?=$ct[option_id]?>"></a><a class="option_minus" data-option_id="<?=$ct[option_id]?>"></a></p>
...
<a href="/" class="cart_order_btn2">쇼핑계속하기</a> <a href="cart_order.php" class="cart_order_btn">구매하기</a>
<div style="clear:both;"></div>
</div>
