...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub04/sub10.php');
    return;
}
...
<style>
/*비오페이스*/
.sub_main {position:relative;width:100%;height:2544px;overflow:hidden; padding-top:50px; }
.sub_main .sub_main_img1 {position:relative; width:100%; height:100%; background:url('/theme/basic/sub04/img/sub_main_img10.jpg') no-repeat 50% 0;} 
