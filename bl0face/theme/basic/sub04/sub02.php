...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub04/sub02.php');
    return;
}
...
<style>
/*�������̽�*/
.sub_main {position:relative;width:100%;height:3676px;overflow:hidden; padding-top:50px; }
.sub_main .sub_main_img1 {position:relative; width:100%; height:100%; background:url('/theme/basic/sub04/img/sub_main_img2.jpg') no-repeat 50% 0;}
