...
<!-- <div id="popup0122" style="position:absolute; margin:0 auto; width:100%; z-index: 15; top:100px; ">
    ...
    <div id="theLayer1121" style="position:absolute; width:500px; margin:0 auto; ">
      <div>
        ...
        <img src="/theme/basic/img/pop/pop0511.png?<?=rand()?>" border="0" style="width: 500px;">
      </div>
      <div style="position:absolute; z-index: 12; float:left; right:10px; bottom:12px;">
...
<script src="/theme/basic/mobile/js/lightslider.js"></script>
	...
	<div class="mobile_main">
		...
		<div class="main_07">
			...
			<img src="/theme/basic/mobile/img/mobile_main_11.jpg" style="width:100%; min-width:600px;">
		</div>
	</div>
</div>
	<!-- 구글 지도 스크립트 -->
