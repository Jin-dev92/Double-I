...
?>
  ...
  <style media="screen">
    .mobile_wrap{width: 100%; max-width: 640px; margin: 0 auto;position: relative;}
    .mobile_wrap > img{width: 640px;}
    table{position: absolute;top:690px;width: 555px; color: #fff; font-size: 18px; left: 50%; margin-left: -277.5px; text-align: right; }
    tr{height: 40px}
    label{color: #fff;}
    input{float: left; margin-right: 5px; margin-left: 10px;height: 30px; color: #000;}
    #ft{display: none;}
    #btn_submit{background: none;}
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/3.3.1/css/swiper.min.css">
    ...
    <form name="fwrite" id="fwrite" action="/bbs/write_update1.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <input type="hidden" name="wr_name" value="<?php echo $wr_subject ?>">
    ...
    <div class="mobile_wrap" >
      ...
      ?>
      <img src="/theme/basic/mobile/skin/board/basic/img/biodb_m.jpg" alt="" usemap="#mapping">
      <?
    }?>
    ...
    <?  if($bo_table == "new_event4"){
      ...
      <?  if($bo_table == "new_event4"){
          ?>
          <tr>
            <th scope="row"><label for="wr_2"> 상담내용 <strong class="sound_only">필수</strong></label></th>
...
.pri{font-size: 16px;}
  ...
  <style media="screen">
    ...
    textarea{width: 350px;float: left;height:200px;color: #000}
    th{padding-left: 40px}
  </style>
  <?
}?>
    <style media="screen">
      .profile_wrap{width: 100%;position: fixed;top:100px;left: 0;background: #fff; display: none;}
