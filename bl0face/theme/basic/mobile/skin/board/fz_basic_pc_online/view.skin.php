...
<article id="bo_v"class="fz_wrap">
	...
	<div class="sec">
	<ul>
		<li><p>상담가능시간 : <?php echo $view['wr_2'] ?>&nbsp;<?php echo $view['wr_3'] ?></p></li>
		<li><p>연락처 :<?php echo $view['wr_1'] ?></p></li>
		<li><p>e-mail :<?php echo $view['wr_email'] ?></p></li>
	<ul>
	</div>
 ...
 <? if($is_admin) {?>
  ...
  include_once('./view_comment.php');
     ?>
	<? } ?>
	<a href="<?php echo G5_URL ?>" class="list_btn btn_next" style="position:absolute;margin-left:550px; margin-top:50px;text-align:center; text-decoration:none; line-height:25px;">HOME</a>
