...
<h2 id="container_title">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="list_btn btn_edit"><i class="fa fa-rotate-right"></i> 编辑</a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="list_btn btn_del" onclick="del(this.href); return false;"><i class="fa fa-remove"></i> 删除</a></li><?php } ?>
            <li><a href="<?php echo $list_href ?>" class="list_btn btn_list"><i class="fa fa-list"></i> 目录</a></li>
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="list_btn btn_reply">답변</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="list_btn btn_write"><i class="fa fa-pencil"></i> 发表</a></li><?php } ?>
        </ul>
        <?php
	...
	<section id="bo_v_info">
		<div class="fl">
			<span class="bo_v_user"><i class="fa fa-user"><span class="sound_only">作者</span></i> <strong><?php echo $view['name'] ?></strong><?php if ($is_ip_view) { echo "<em>$ip</em>"; } ?></span>
		</div>
		<div class="fr">
			<span class="bo_v_date"><i class="fa fa-calendar-check-o"><span class="sound_only">发表日期</span></i> <strong><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong></span> <span class="bar">|</span>
			<span class="bo_v_hit"><i class="fa fa-eye"></i> 查询 <strong><?php echo number_format($view['wr_hit']) ?></strong></span> <span class="bar">|</span>
			<span class="bo_v_comment"><i class="fa fa-comments"></i> 回复 <strong><?php echo number_format($view['wr_comment']) ?></strong></span>
		</div>
	</section>
	...
	<div class="fz_middle_btn">
		<div class="fl">
			<?php if ($prev_href) { ?><a href="<?php echo $prev_href ?>" class="list_btn btn_prev">上一个</a><?php } ?><?php if ($next_href) { ?><a href="<?php echo $next_href ?>" class="list_btn btn_next">下一个</a><?php } ?>
		</div>
		<div class="fr">
			<?php
