	...
	<div class="bo_w_form">
		...
		<div class="bo_write_mbinfo">
			<ul>
				...
				<?php }?>
				<li><span class="placeholder"><input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="i_text wr_1" maxlength="100"><label for="wr_1">연락받으실 휴대폰 번호</label></span></li>
			</ul>
