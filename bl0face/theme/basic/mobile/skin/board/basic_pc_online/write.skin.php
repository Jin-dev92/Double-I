...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_password" id="wr_password" <?php echo $password_required ?> class="frm_input <?php echo $password_required ?>" maxlength="20">(휴대폰 번호가 비밀번호가 됩니다.)
						<input type="hidden" name="wr_1" id="wr_1"  class="frm_input" maxlength="13">
					</td>
        </tr>
        <?php } ?>
	...
	var cellPhone = document.getElementById('wr_password');
