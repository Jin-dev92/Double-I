	...
	<div class="bo_w_form">
		...
		<div class="bo_write_mbinfo">
			<ul>
				...
				<?php }?>
				<?php if($is_password){?>
				<li><span class='placeholder'><input type="password" name="wr_password" id="wr_password" style="width:200px;"<?php echo $password_required ?> class="i_text <?php echo $password_required ?>" maxLength="20"><label for="wr_password" style="width:200px;">
The cell phone number is the password.</label></span></li>
				<?php }?>
				<?php if($is_email){?>
