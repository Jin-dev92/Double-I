...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub02/sub02.php');
    return;
}
...
<style>
/*�������̽�*/
.sub_main {position:relative;width:100%;height:4697px;overflow:hidden; padding-top:50px; }
.sub_main .sub_main_img1 {position:relative; width:100%; height:100%; background:url('/theme/basic/sub02/img/sub_main_img2.jpg') no-repeat 50% 0;}
.sub_main .sub_main_gif1 { position: absolute; width:100%; height: 300px; margin-top:-1841px; margin-left:-13px; text-align: center; }
</style>
<div id="sub_title">
		<ul class="sub_ul">
