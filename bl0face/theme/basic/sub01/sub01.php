...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub01/sub01.php');
    return;
}
include_once(G5_THEME_PATH.'/include/sub_head.php');
?>
<style>
#sub_mainImg {position:relative;width:100%;height:10879px;overflow:hidden;}
#sub_mainImg .sb_img {position:relative;width:100%;height:100%;margin-top: 50px;background:url('/theme/basic/sub01/img/sub01.jpg') no-repeat 50% 0;
</style> 
