...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" class="<?=$list[$i][indent]?>">
        ...
        <footer>
            <ul class="bo_vc_act">
                <?php if ($list[$i]['is_reply']) { ?><a href="<?php echo $c_reply_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;" class="list_btn1 btn_reply1">답글달기</a><?php } ?>
                <?php if ($list[$i]['is_edit']) { ?><a href="<?php echo $c_edit_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;" class="list_btn1 btn_edit1">수정</a><?php } ?>
                <?php if ($list[$i]['is_del'])  { ?><a href="<?php echo $list[$i]['del_link'];  ?>" onclick="return comment_delete();" class="list_btn1 btn_del1">삭제</a><?php } ?>
            </ul>
        </footer>
...
function fviewcomment_submit(f)
{
    ...
    <?php if($is_guest) echo chk_captcha_js();  set_comment_token(f); ?>
