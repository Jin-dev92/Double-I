	...
	<div class="bo_w_form">
		...
		<div class="bo_write_mbinfo">
			<ul>
				...
				<?php }?>
				<?php if($is_password){?>
				<li><span class='placeholder'><input type="password" name="wr_password" id="wr_password" <?php echo $password_required ?> class="i_text <?php echo $password_required ?>" maxLength="20"><label for="wr_password">密码为手机号</label></span></li>
				<?php }?>
				<?php if($is_email){?>
