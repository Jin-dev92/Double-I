...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_design1">ADMIN</a></li><?php } ?>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">Reply</span><?php echo $list[$i]['comment_cnt']; ?><span class="sound_only">개</span><?php } ?>
                </a>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>" class="btn_design2">List</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_design1">Write</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
...
<fieldset id="bo_sch">
    ...
    <input type="submit" value="Search" class="btn_design2">
    </form>
</fieldset>
<!-- } 게시판 검색 끝 -->
