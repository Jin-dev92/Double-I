...
<section id="bo_w">
    ...
    <input type="hidden" name="wr_password" id="wr_password" value="">
    <?php
    $option = '';
    $option_hidden = '';
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_1" id="wr_1"  class="frm_input required" maxlength="13"></td>
        </tr>
    ...
    function fwrite_submit(f)
    {
		...
		var passWord = document.getElementById("wr_1").value;
		var passwordAfter = passWord.split("-");
		var realpassword = passwordAfter[0]+passwordAfter[1]+passwordAfter[2];
		var passWord2 = document.getElementById("wr_password").value;
		
		function aa(){
			var passWord2 =  realpassword;
			alert(passWord2);
		}
		aa();
