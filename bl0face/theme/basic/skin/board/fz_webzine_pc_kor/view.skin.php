...
<article id="bo_v" class="fz_wrap">
    ...
    <header>
        <h1 id="bo_v_title">
            ...
            ?>
			<span class="bo_v_date_2"><span class="sound_only">작성자</span>
				<?php
					if($bo_table == "event_kor") {
				?>
					<strong>이벤트기간 : <?php echo $view['wr_1'] ?> ~ <?php echo $view['wr_2'] ?></strong>
				<?PHP
					}
				?>
			</span>
	...
	<section id="bo_v_info">
		...
		<div class="fr">
			<span class="bo_v_date"><i class="fa fa-calendar-check-o"><span class="sound_only">작성일</span></i> <strong><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong></span>
	<?php
		if($bo_table == "event_kor") {
	?>
			<span class="bar">|</span>
