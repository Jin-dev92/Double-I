...
<div id="title_total">
		<ul>
			<li>
				...
				<?php } ?>
				<span>Total <b><?php echo number_format($total_count) ?></b> gallery</span>
				<font><?php echo $page ?></font> Page
			</li>
		</ul>
	</div>
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
                ...
                <li><span class="gall_subject">Writer </span><?php echo $list[$i]['name'] ?></li>
                <li><span class="gall_subject">Date </span><?php echo $list[$i]['datetime'] ?></li>
                <li><span class="gall_subject">Count </span><?php echo $list[$i]['wr_hit'] ?></li>
                <?php if ($is_good) { ?><li><span class="gall_subject">Good</span><strong><?php echo $list[$i]['wr_good'] ?></strong></li><?php } ?>
                <?php if ($is_nogood) { ?><li><span class="gall_subject">Bad</span><strong><?php echo $list[$i]['wr_nogood'] ?></strong></li><?php } ?>
            </ul>
        </li>
        <?php } ?>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="wr_subject||wr_content"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>Subject+Contents</option>
