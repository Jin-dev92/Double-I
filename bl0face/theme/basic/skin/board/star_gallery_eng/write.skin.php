...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">part<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i;  ?>]" value="1"> <label for="bf_file_del<?php echo $i ?>"><?php echo $file[$i]['source'].'('.$file[$i]['size'].')';  ?> file del</label>
                <?php } ?>
            </td>
        </tr>
        <?php } ?>
