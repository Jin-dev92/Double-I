...
<h2 id="container_title">
	...
	<section id="bo_v_info">
		...
		<div class="fr">
			<span > 핸드폰 : <strong><?php echo ($view['wr_1']) ?></strong></span> <span class="bar">|</span>
	...
	<?php
		...
		?>
		<?PHP
			} else if($bo_table == "counsel" || $bo_table == "online_kor" || $bo_table == "online_eng" || $bo_table == "online_chn") {
			 // 코멘트 입출력
