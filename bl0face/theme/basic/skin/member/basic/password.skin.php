...
<div id="pw_confirm" class="mbskin">
	<h1><i class="fa fa-lock"></i><?php echo $g5['title'] ?></h1>
    <p>
        <?php if ($w == 'u') { ?>
        <strong class="pw-label">작성자만 글을 수정할 수 있습니다.</strong>
        <strong class="pw-p">작성자 본인이라면, 글 작성시 입력한 비밀번호를 입력하여 글을 수정할 수 있습니다.</strong>
        <?php } else if ($w == 'd' || $w == 'x') {  ?>
        <strong class="pw-label">작성자만 글을 삭제할 수 있습니다.</strong>
        <strong class="pw-p">작성자 본인이라면, 글 작성시 입력한 비밀번호를 입력하여 글을 삭제할 수 있습니다.</strong>
        <?php } else {  ?>
        <strong class="pw-label">비밀글 기능으로 보호된 글입니다.</strong>
        <strong class="pw-p">작성자와 관리자만 열람하실 수 있습니다. 본인이라면 비밀번호를 입력하세요.</strong>
        <?php }  ?>
    </p>
