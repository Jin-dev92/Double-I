...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/tail.php?'.rand());
    return;
}
?>
...
#ft #ft_go #ft_gg ul#go3 li#sec { padding-bottom:20px; color:#ffffff; }
#sec2 {color:#ffffff; margin-top:-20px;}
...
<div id="ft">
    <div id="ft_catch"><img src="/theme/basic/img/main/footer_logo.png" alt="비오페이스"></div>
    <div id="ft_company">
    </div>
	<div id="ft_go">
		<div id="ft_gg">
			<ul id="go1">
				...
				<li>월수금 : AM 11:00 ~ PM 09 : 00</li>
				<li>화&nbsp;&nbsp;목 : AM 11:00 ~ PM 07 : 00</li>
				<li>토요일 : AM 11:00 ~ PM 05 : 00</li>
			</ul>
			<ul id="go2">
				<li id="title"><b>ADRESS</b></li>
				<li id="first">서울특별시 강남구 강남대로 152길 22(신사동)</li>
				<li id="sec">신사역 8번 출구</li>
			</ul>
			<ul id="go3">
				<li id="title"><b>LICENCE</b></li>
				<li id="first">사업자 등록번호 : 605 - 25 - 72864</li>
				<li id="sec">대표자 : 박주영</li>
				<li id="sec2">상호명 : 비오페이스의원</li>
			</ul>
			<ul id="go4">
				<li id="title"><b>SOCIAL</b></li>
				<li id="first">
					<ul id="go4_u">
						<li id="go4_u_f"><a href="https://www.facebook.com/biofacefiller"><img src="/theme/basic/img/main/facebook_btn.png"></a></li>
						<li id="go4_u_s"><a href="http://instagram.com/bioface_seoul"><img src="/theme/basic/img/main/instargram_btn.png"></a></li>
						<li><a href="http://goto.kakao.com/@비오페이스서울신사본점"><img src="/theme/basic/img/main/kakao_btn.png"></a></li>
					</ul>
				</li>
