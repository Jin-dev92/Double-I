...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub06/sub04.php');
    return;
}
...
<div class="sub_main" style="height: auto; min-width: 1200px;">
	...
	<div class="row" style="margin-top: 60px; max-width: 1200px;">
		<div class="col s12">
			<ul class="tabs">
				...
				<li class="tab col s3"><a class="active pisto" href="/theme/basic/sub06/sub04.php">피스토주사</a></li>
	...
	<div id="pisto" class="col s12 sub02_img" style="height: auto;">
		<img src="/theme/basic/sub06/img/sub_02_pisto_01.jpg">
		<img src="/theme/basic/sub06/img/sub_02_pisto_02.jpg">
		<img src="/theme/basic/sub06/img/sub_02_pisto_03.jpg">
		<img src="/theme/basic/sub06/img/sub_02_pisto_04.gif">
		<img src="/theme/basic/sub06/img/sub_02_pisto_05.jpg">
		<img src="/theme/basic/sub06/img/sub_02_pisto_06.jpg"">
		<img src="/theme/basic/sub06/img/sub_02_pisto_07.gif">
		<img src="/theme/basic/sub06/img/sub_02_pisto_08.jpg">
		<img src="/theme/basic/sub06/img/sub_02_pisto_09.gif">
		<img src="/theme/basic/sub06/img/sub_02_pisto_10.jpg">
		<div class="container two_btn_wrap">
			<img class="two_btn" style="max-width: 214px;"  src="/theme/basic/sub06/img/sub_02_pisto_11.gif" onclick="go_pic()">
			<img class="two_btn" style="max-width: 474px;" src="/theme/basic/sub06/img/sub_02_pisto_12.gif" onclick="go_brain()">
		</div>
