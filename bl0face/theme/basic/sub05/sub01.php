...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/sub05/sub01.php');
    return;
}
...
.sub_main .sub_main_img1 {position:relative; width:100%; height:100%; background:url('/theme/basic/sub05/img/sub_main_img1.jpg') no-repeat 50% 0;} 
</style>
<div id="sub_title">
		<ul class="sub_ul">
