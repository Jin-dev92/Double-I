...
<div class="bg" style="width: 100%; height: auto; background-image: url(/assets/img/intro_content01_on.jpg); background-size: cover; background-position: center;">
  <div class="agree">
    <div class="agree_box" style="">
      ...
      <span>약관에 동의하셔야 회원가입 가능합니다.</span>
      <p>회원가입약관에 동의합니다.<label style="margin-left: 10px;"><input type="checkbox" name="agree1" class="agree1" value=""><span></span></label></p>
      <h4>개인정보처리방침안내</h4>
      ...
      <span>약관에 동의하셔야 회원가입 가능합니다.</span>
      <p>개인정보처리방침안내의 내용에 동의합니다.<label style="margin-left: 10px;"><input type="checkbox" name="agree2" class="agree2" value=""><span></span></label></p>

      <input type="submit" class="agree_btn"value="약관동의">
    </div>
