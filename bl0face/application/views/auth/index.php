<style media="screen">
  .reg_textarea{
    ...
    background: #f7f7f7;}
.container{width: 70%;}
.regicheck1, .regicheck2{float: right;}
.regitable{width: 70%; margin:0 auto;}
.regitable td{border:1px solid #d1dee2; }
.regitable tr{border:1px solid #d1dee2;}
.regirow1{text-align: center;}
.regirow2{text-align: center;}
...
<div class="container">
  <form class="frm" action="../register/signup" method="post">
  <div class="regirow1">
    <h4>회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.</h4>
    <h3>회원가입약관</h3>
    <textarea name="name" rows="8" cols="80" readonly class="reg_textarea">
      제 1 장 총 칙

제 1 조 (목적)
이 이용약관(이하 '약관')은 비오페이스(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.


제 2 조 (이용약관의 효력 및 변경)

(1) 이 약관은 본 사이트에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
(2) 본 이용약관에 대한 동의는 이용신청 당시 해당 웹의 '동의함' 버튼을 누름으로써 의사표시를 합니다.
...
(2) 모든 회원은 반드시 회원 본인의 이름을 제공하여야만 서비스를 이용할 수 있으며, 실명으로 등록하지 않은 사용자는 일체의 권리를 주장할 수 없습니다.

(3) 회원가입은 반드시 실명으로만 가입할 수 있으며 회사는 실명확인조치를 할 수 있습니다.

(4) 타인의 명의(이름)을 도용하여 이용신청을 한 회원의 모든 ID는 삭제되며, 관계법령에 따라 처벌을 받을 수 있습니다.
...
(3) 이용자ID는 이용자 본인의 동의하에 회사가 운영하는 허브 사이트의 회원ID와 연결될 수 있습니다.
...
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 웹 내의 메뉴를 이용해 가입해지를 해야 합니다.
...
<부칙>
(시행일) 본 약관은 2005년 10월 21일부터 적용됩니다.
    </textarea><br>
<span class="regicheck1">회원가입 약관의 내용에 동의합니다. <input type="checkbox" name="chk1" id="chk1"></span><br>
<div class="regirow2">
  <h3>개인정보처리방침안내</h3>
  ...
  <span class="regicheck2">개인정보처리방침안내의 내용에 동의합니다. <input type="checkbox" name="chk2" id="chk2"></span>
  <input type="submit" name="btn_submit" value="회원가입" class="btn_submit">
</div>
  </div>
</form>
  <!--row -->
