...
<img class="bg" src="/assets/img/sub/sub_main_head_img.jpg">
  <div class="write" style="width: 100%;">
    ...
    ?>
    <?
    echo form_open_multipart('/board/modify_process_event/'.$bo_name.'/'.$bo_no);
    ?>
      ...
      <ul>
        ...
        <div class="col m12 s12">
          ...
          <li>
            ...
            ?>
            <input style="width: 200px;" type="file" name="wr_file" class="wr_file"
            value="<?if($modify['img'][0]['bf_file']){ echo $modify['img'][0]['bf_file']; } ?>">
            <input style="width: 200px;" type="file" name="wr_file" class="wr_file2"
            value="<?if($modify['img'][1]['bf_file']){ echo $modify['img'][1]['bf_file']; } ?>">
            <?}?>
          </li>
        </div>
