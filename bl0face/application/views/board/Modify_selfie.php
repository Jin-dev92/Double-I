...
<div class="write_wrap container" style="padding: 0;">
  <div class="write">
    ...
    <form class="form form-horizontal" action="/board/modify_process_selfie/selfie_kor/<?=$modify['wr_id']?>" method="post" enctype="multipart/form-data">
      <input type="hidden" name="mb_id" value="<?=$this->session->userdata('id')?>">
      <div class="control-group row">
        <h4 class="align_center">수정</h4>
      <ul>
        <div class="col m12 s12">

          <li>이름</li>
          <li><input type="text" name="wr_name" class="wr_name" value="<?=$modify['wr_1']?>" placeholder="이름을 입력해주세요."></li>
        </div>
        <div class="col m12 s12">
          <li>나이</li>
          <li><input type="text" name="wr_age" class="wr_age" value="<?=$modify['wr_2']?>" placeholder="이름을 입력해주세요."></li>
        </div>
        <div class="col m12 s12">
          <li>수술부위</li>
          <li><input type="text" name="wr_subject" class="wr_subject" value="<?=$modify['wr_subject']?>" placeholder=",로 구분하여 입력해주세요."></li>
        </div>
        <div class="col m12 s12">
          <li>분류</li>
          <li>
            ...
            <div class="input-field col s12">
              <select multiple name="category1">
                ...
                <option value="fullface" <?if(strpos($modify['wr_3'],"fullface") !== false) echo 'selected';?>>풀페이스필러</option>
                <option value="lifting" <?if(strpos($modify['wr_3'],"fullface") !== false) echo 'lifting';?>>리프팅</option>
                <option value="body" <?if(strpos($modify['wr_3'],"body") !== false) echo "selected";?>>바디필러</option>
              </select>
            </div>
          </li>
        </div>
        <div class="col m12 s12">
          <li>내용</li>
          <li>
            <textarea name='editor1' id='editor1' style='display:none;'><?=$modify['wr_content']?></textarea>
        ...
        <div class="col m12 s12">
          ...
          <input type="file" id="wr_file" name="wr_file1" class="wr_file" value="">
        ...
        <div class="col m12 s12">
          <li style="width: 100%; text-align: center;">
            ...
            <a href="/board/lists/selfie_kor/1"><button type="button" class="waves-effect waves-light comment_btn" value="목록으로">목록으로</button></a>
          </li>
        </div>
      </ul>
      </div>
...
$(document).ready(function(){
  ...
  // 에디터 내용
  var selfie_content = '<?=$modify['wr_content']?>';
  // console.log(selfie_content);
  // cheditor2('cheditor2',selfie_content);
  $('.cheditor-editarea').contents().find('body').html(selfie_content);
});
