...
class Board extends CI_Controller {
	...
	public function lists($bo_name,$page)
	{
		...
		if ($bo_name=="online_kor" || $bo_name=="quick_kor") {
        ...
        } else if ($bo_name=="promotion") {
			$this->load->view('board/Album_promotion' , array("list"=>$data));
		} else if ($bo_name=="exhibitions") {
			$this->load->view('board/Album_exhibitions' , array("list"=>$data));
		} else {
	...
	public function write($bo_name)
	{
        ...
        if($bo_name == 'event_kor'){
            ...
            $this->load->view('board/Write_promotion', $data);
        } else if($bo_name == 'exhibitions') {
            $this->load->view('board/Write_exhibitions', $data);
        } else {
    ...
    function write_process_promotion($bo_name){

		$result = $this->Board_m->setContent_promotion();
		if ($result) {
			alert("글이 등록 되었습니다.","/board/lists/$bo_name/1");
		}else {
			alert("글 등록에 실패하였습니다.","/board/lists/$bo_name/1");
	...
	function write_process_exhibitions($bo_name){

		$result = $this->Board_m->setContent_exhibitions();
		if ($result) {
			alert("글이 등록 되었습니다.","/board/lists/$bo_name/1");
		}else {
			alert("글 등록에 실패하였습니다.","/board/lists/$bo_name/1");
    ...
    function modify_process_promotion($bo_name,$bo_no)
	{

		$result = $this->Board_m->modify_process_promotion();
		if ($result) {
			alert("글이 수정 되었습니다.","/board/lists/$bo_name/1");
		}else {
			alert("글 수정에 실패하였습니다.","/board/lists/$bo_name/1");
	...
	function modify_process_exhibitions($bo_name,$bo_no)
	{

		$result = $this->Board_m->modify_process_exhibitions();
		if ($result) {
			alert("글이 수정 되었습니다.","/board/lists/$bo_name/1");
		}else {
			alert("글 수정에 실패하였습니다.","/board/lists/$bo_name/1");
