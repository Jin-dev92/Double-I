...
<html>
  ...
  <body>
    <div class="top_form">
            ...
            <div class="col m4 s8">
              ...
              <div class="input-field col m7 s12">
                <select class="content" name="content">
                  <option value="" selected disabled style="text-align:center;">선택</option>
                  <option value="골반필러">힙업&골반필러</option>
      ...
      <!-- 퀵버튼 -->
      <div class="quick_btn hidden-s">
        <img src="assets/img/quick_btn.png" alt="퀵메뉴" id="quick" usemap="#quick">
        <map id="quick" name="quick">
          <area shape="rect" alt="" title="" coords="0,0,110,110" href="http://www.bioface.kr/bbs/board.php?bo_table=filler_review_kor" target="" />
          <area shape="rect" alt="시술영상" title="" coords="0,130,110,240" href="https://www.youtube.com/watch?v=WRdRyBR9GRc" target="" />
          <area shape="rect" alt="카톡상담" title="" coords="0,265,110,375" href="https://pf.kakao.com/_xaiCuxd" target="" />
          <area class="modal-trigger" shape="rect" alt="팝업" title="" coords="0,400,110,505" href="#modal_m" data-target="modal_m" /><!-- Created by Online Image Map Editor (http://www.maschek.hu/imagemap/index) -->
        </map>
      </div>
      <!-- 퀵버튼 -->
    </div>
    ...
    <!-- 모바일 퀵버튼 -->
    <div class="quick_btn hidden-m">
      <img src="assets/img/quick_btn.png" alt="퀵메뉴" usemap="#quick2">
      <map id="quick2" name="quick2">
        <area shape="rect" alt="" title="" coords="0,0,70,70" href="http://www.bioface.kr/bbs/board.php?bo_table=filler_review_kor&device=mobile" target="" />
        <area shape="rect" alt="시술영상" title="" coords="0,85,70,155" href="https://www.youtube.com/watch?v=WRdRyBR9GRc" target="" />
        <area shape="rect" alt="카톡상담" title="" coords="0,170,70,240" href="https://pf.kakao.com/_xaiCuxd" target="" />
        <area class="modal-trigger" shape="rect" alt="팝업" title="" coords="0,255,70,325" href="#modal_m" data-target="modal_m" /><!-- Created by Online Image Map Editor (http://www.maschek.hu/imagemap/index) -->
      </map>
    </div>
    ...
    <div class="top_form2">
      <ul class="tabs tabs-fixed-width tab-demo z-depth-1">
        <li class="tab"><a class="active" href="#hippelvis">힙업&골반필러</a></li>
        <li class="tab"><a href="#leg">휜다리교정필러</a></li>
      </ul>
    </div>

    <div id="hippelvis" class="col s12">
      <div class="full">
        <div class="hidden-m">
          <img src="assets/img/event_body_main1_m.jpg" alt="" style="    margin-top: 50px;">
        </div>
        <div class="hidden-s">
          <img src="assets/img/event_body_main1.jpg" alt="">
        </div>
      </div>
    </div>
    <div id="leg" class="col s12">
      <div class="full">
        <div class="hidden-m">
          <img src="assets/img/event_body_main2_m.jpg" alt="" style="    margin-top: 50px;">
        </div>
        <div class="hidden-s">
          <img src="assets/img/event_body_main2.jpg" alt="">
        </div>
      </div>
    </div>
    <!-- 탭 -->
