...
<html>
  <head>
    ...
    <style media="screen">
      ...
      .full img{width: 100%;}
      .top_form{position: fixed; width: 100%; height: 170px; top:0;left:0;background: #383428;z-index: 99;}
      ...
      .submitBtn{ width: 100%; height: 100px; color: #fff;font-size: 18px; font-weight: bold; margin: 50px 0; padding: 30px 0; background: #df424f!important}
      ...
      @media (max-width:600px) {
        ...
        .full{padding-top: 0;}
        .top_form{height: 270px; top:auto; bottom: -270px;}
  ...
  <body>
    <div class="top_form">
      <div class="trigger_wrap">
        <div class="real_trigger">
          <img src="assets/img/trigger.png" class="in_trigger" alt="">
        </div>
        <p>상담신청하기</p>
      </div>
      <div class="container">
        ...
        <div class="row">
          <div class="col m2 hidden-s">
            <div class="row">
              <img src="assets/img/logo.png" alt="" style="padding-top:50px;">
            </div>
          </div>
          <div class="col m8 s8">
            ...
            <div class="input-field col m4 s6">
              <select class="content" name="content">
                ...
                <option value="포니테일리프팅">포니테일리프팅</option>
                <option value="리프톡스">리프톡스</option>
                </select>
              <label>상담내용</label>
            </div>
            <div class="input-field col m12 s12">
  					    ...
  					    <div class="col s4">
  							<input id="first_name" type="text" class="validate phone2"  name="phone2" data-length="4">
  			          	</div>
  			          	<div class="col s4">
  			          		<input id="first_name" type="text" class="validate phone3" name="phone3" data-length="4">
  			          	</div>
  					</div>
            <div class="col s12 ">
              <input type="checkbox" name="agree" id="agree" class="agree filled-in">
              <label for="agree">개인정보수집동의 <a href="#modal1" class="modal-trigger">[수집동의]</a></label>
          ...
          <div class="col m2 s4">
            <div class="center">
              <a href="#" class="btn submitBtn">상담신청</a>
    ...
    <div class="full">
      <div class="hidden-m">
        <img src="assets/img/event_main_m.jpg" alt="">
      </div>
      <div class="hidden-s">
        <img src="assets/img/event_main.jpg" alt="">
      </div>
    </div>
    <!-- Modal Structure -->
    ...
    $(document).ready(function() {
      $(".real_trigger").click(function(){
        if (trigger_idx ==0) {
          ...
          $(".top_form").animate({"bottom":"-270px"},300);
          trigger_idx=0;
        }
      ...
      $(".submitBtn").click(function(){
        ...
        var name = $(".name").val();
        var can_date = $(".can_date option:selected").val();
