...
<div class="container">
	...
	<div class="row"><div class="col-sm-12"><img src="assets/img/top.jpg?<?=rand()?>"></div></div>
	...
	<div class="row">
		<div class="col s12">
			...
			<div class="input-field col m4 s4 submit">
				 <button class="btn waves-effect waves-light" type="submit" name="action">상담신청
				</button>
			</div>
		</div>
	</div>
...
본 개인정보보호정책은 2014년 10월 26일부터 시행합니다.</p>
	...
	<div class="row"><div class="col-sm-12"><img src="assets/img/bottom.jpg?<?=rand()?>"></div></div>
