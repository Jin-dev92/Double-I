...
<div class="container">
	...
	<div class="row" style="background-color: #FFDA67"><div class="col-sm-12"><img src="assets/img/top3.jpg?<?=rand()?>"></div></div>
	...
	<div class="row" style="margin-bottom: 0;">
		<div class="col-sm-12 bottomImg">
			<img src="assets/img/bottom3.jpg?<?=rand()?>">
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12 bottomImg" style="position: relative;">
			<img src="assets/img/tel.jpg?<?=rand()?>" style="position: relative;">
			<a href="tel:02-1833-8838"><div class="tel1"></div></a>
			<a href="tel:010-4145-7976"><div class="tel2"></div></a>
		</div>
	</div>
